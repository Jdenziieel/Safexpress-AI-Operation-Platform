...
import { Clock, Trash2, FileText, ExternalLink, ArrowLeft } from "lucide-react";
...
function ABCAnalysisHistory() {
  ...
  return (
    <div className="analysis-report-page-2">
      <div className="analysis-report-container-2">
        <div className="analysis-report-header-row-2">
          <div>
            <ActionButton
              icon={ArrowLeft}
              className="abc-history-header-action-button-back"
              onClick={() => navigate('/analysis-abc')}
            >
              Back to ABC Analysis
            </ActionButton>
            <h1 className="analysis-report-header-title-2">
              ABC Analysis History
            </h1>
            <div className="analysis-report-header-subtitle-2">
              View and manage your past ABC analyses
            </div>
          </div>
          <div className="abc-history-header-actions">
            {analysisHistory.length > 0 && (
              <ActionButton
                icon={Trash2}
                className="abc-history-header-action-button-clear"
